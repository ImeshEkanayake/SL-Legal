#!/usr/bin/env python3
"""Build a local release attestation envelope for the latest completed V2 phase."""
...
from sl_legal_rag.operations import build_release_attestation, load_release_attestation_manifest  # noqa: E402


DEFAULT_MANIFEST = PROJECT_ROOT / "rag" / "evals" / "phase13_release_attestation.json"
DEFAULT_OUTPUT = PROJECT_ROOT / "logs" / "release-artifacts" / "phase13-release-attestation.json"
...
def main(argv: list[str]) -> int:
    ...
    manifest = load_release_attestation_manifest(resolve_path(args.manifest))
    ...
    return 0 if args.allow_failures or attestation["status"] == "verified" else 1
